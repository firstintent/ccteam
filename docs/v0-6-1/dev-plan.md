...
- ✅ 落 `docs/v0-6-1/README.md`
- ✅ 落 `docs/v0-6-1/prd.md`
- ✅ 落 `docs/v0-6-1/dev-plan.md`(本文件)
- ⏭️ user review → "go"
...
**Briefing 关键点**:
- 读 `docs/v0-6-1/prd.md` §F119 + §F120
- 读 `docs/v0-6-0/host-probe.md` §Observations 1-3
...
**Briefing**:
- 读 `docs/v0-6-1/prd.md` §F125 + §F126
- **F126 EN README**:`README.md` EN-only rewrite,保 V0.6.0 3-mode 平等 narrative + 5 preset 表;**删现 "Status / V0.6.x 蓄势" 段**(用户看的 README 不夹版本进展);footer 只留 1 行 `See [docs/v0-6-1/README.md](docs/v0-6-1/README.md) for release notes`;长度 ≤80 行
- **F126 CLAUDE.md 红线 2 row**:
  1. `| **root README.md MUST be English** | 守 | 守 | 守 |`
  2. `| **README.md 不含版本进展/状态信息** | 守 | 守 | 守 |`(版本进展去 `docs/v0-X-Y/README.md`)
...
- **不**动 `docs/v0-X-Y/` 历史归档(per CLAUDE.md §五)
...
- 落 `docs/v0-6-1/wave-1-handoff.md`(Decided / Rejected / Risks / Files / Remaining 5 段)
...
- 落 `docs/v0-6-1/wave-2-handoff.md`
- TG ping milestone
...
**Briefing**:
- 读 `docs/v0-6-1/prd.md` §F123
- 5 GIF 录到 `docs/v0-6-0/demos/`(注意:V0.6.0 dir,本版补)
...
- 落 `docs/v0-6-0/demos/README.md` recipe
...
**Briefing**:
- 读 `docs/v0-6-1/prd.md` §F125 §4 CLAUDE.md baseline 同步
...
- 落 `docs/v0-6-1/wave-3-handoff.md`(Decided / Rejected / Risks / Files / Remaining)
