...
`docs/versions/v0-3/e2e-retro.md` —— 模仿 V0.2.2 retro 模板:
...
- `docs/versions/v0-2/README.md`:已在 doc-only kickoff PR 加 V0.3 起始 pointer;ship
  时不再改
...
- [ ] `docs/versions/v0-2/README.md` V0.3 pointer 改为 "已 ship"
