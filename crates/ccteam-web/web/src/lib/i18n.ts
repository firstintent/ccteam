...
export const I18N: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    starting: "创建会话中…",
    team: "团队",
    teamDesc: "跨 harness、跨主机的委派全景 —— 成员树 + 时间轴 + 拓扑,点行/节点看详情。",
  ...
  en: {
    ...
    team: "Team",
    teamDesc: "The delegation picture across harnesses and hosts — roster tree, timeline, topology; click a row/node for details.",
