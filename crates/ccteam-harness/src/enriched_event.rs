...
pub fn enrichment_source(kind: EventKind, vendor: Vendor) -> EnrichmentSource {
    ...
    match (kind, vendor) {
        ...
        (ToolCallCompleted, Opencode) => None,
        ...
        (UserPromptSubmitted, Opencode) => None,
