...
| 测试 baseline | `2045/0`(`cargo test --workspace --exclude ccteam-web`;v0.8.19 末加结构化 activity 事件 +6 测);`ccteam-web` = **258** pass;vitest **207** pass(SPA;+IME 守卫/原语/主题/combobox/activity 单测);Playwright 4 pass(SPA smoke)|
