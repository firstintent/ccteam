...
>
> 配套文档：
> - 需求决策：`docs/versions/v0-4-0/prd.md`
> - 文档索引：`docs/versions/v0-4-0/README.md`（待建）
>
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F60
...
- [ ] **#1.9** 文档同步
  ...
  - 注释掉（不删）`docs/versions/v0-1/` 下 phase 相关设计文档的引用（历史归档保留）
...
- docs/versions/v0-4-0/prd.md §F60
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F61
...
- docs/versions/v0-4-0/prd.md §F61
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F62 + `docs/research/ccteam-codex-integration.md`
...
- docs/versions/v0-4-0/prd.md §F62
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F63
...
- docs/versions/v0-4-0/prd.md §F63
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F64
...
- docs/versions/v0-4-0/prd.md §F64
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F65
...
- docs/versions/v0-4-0/prd.md §F65
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F66
...
- docs/versions/v0-4-0/prd.md §F66
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F67
...
- docs/versions/v0-4-0/prd.md §F67
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F68
...
- docs/versions/v0-4-0/prd.md §F68
...
**关联 PRD**：`docs/versions/v0-4-0/prd.md` §F69
...
- [ ] **#10.4** 文档更新
  - 新文件 `docs/versions/v0-4-0/README.md`（F60-F69 ship 状态）
  - 新文件 `docs/versions/v0-4-0/user-manual.md`（workflow.yaml 用法 + agent role 配置 + MCP 工具列表）
...
- [ ] **#10.5** ship gate
  ...
  - 写 `docs/versions/v0-4-0/e2e-retro.md`（e2e 运行结果 + 发现的问题 + 修复记录）
...
## 任务来源
- `docs/versions/v0-4-0/prd.md` §F<NN> 全文
- `docs/versions/v0-4-0/dev-plan.md` §<对应章节>（本文档）
...
写完 `docs/versions/v0-4-0/e2e-retro.md`（包含上述命令实际输出截图或文字）后才发 ship gate PR。
