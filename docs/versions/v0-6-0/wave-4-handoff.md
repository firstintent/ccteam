...
- **`docs/versions/v0-6-0/host-probe.md`** 含真实 probe 结果(`run 20260519T013822Z`):8/8 场景 rc=0;3 codex happy / 2 TG real-partial / 2 mode-1 manual / 1 mode-2 mock。Real TG bidirectional 独立验证(curl getMe + sendMessage + getUpdates 收 user reply,message_ids 363/364/366/367)。
- **`docs/versions/v0-6-0/demos/`** + README:V0.6.0 不录 demo GIF,defer V0.6.1 用 asciinema → agg 录(handoff 含 recipe)。
...
- `docs/versions/v0-6-0/{host-probe, demos/README, wave-4-handoff}.md` + `docs/versions/v0-6-0/demos/.gitkeep`
...
- `docs/versions/v0-1/user-quickstart.md` + `docs/versions/v0-4-6/user-manual.md` + `docs/research/v047-pattern-rust-vs-skill-split.md` + `docs/versions/v0-6-0/wave-1-handoff.md`(子前缀 sed sweep)
