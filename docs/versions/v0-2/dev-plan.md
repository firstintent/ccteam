...
>
> 配套文档:
> - 需求决策:`docs/versions/v0-2/prd.md`
> - 设计依据:`docs/versions/v0-2/alignment-review.md`
> - 子设计:`docs/versions/v0-2/phase-prompt-architecture.md`
>
> CLAUDE.md 约定:**`docs/versions/v0-1/development-plan.md` 只追当前 in-flight 任务**;V0.2 进入
> in-flight 时,`docs/versions/v0-1/development-plan.md` reference 本文档,不复制。
...
详见 `docs/versions/v0-2/phase-prompt-architecture.md` §11 详细步骤。
...
- `docs/versions/v0-2/phase-prompt-architecture.md` 已是 SoT,无需更新
...
- 新建 `docs/versions/v0-2/team-factory-userguide.md` 用户指南(简短,~100 行)
...
- 2026-05-07:初稿。基于 docs/versions/v0-2/prd.md + alignment review 拆 8 个 milestone
