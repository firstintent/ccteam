...
- **F51**:chore + ship gate — workspace.version `0.3.0` → `0.3.1`、
  CLAUDE.md baseline 回填、e2e for flex multi-session、`docs/versions/v0-3-1/e2e-retro.md`、
  `docs/versions/v0-2/README.md` 更新
...
impl HarnessAdapter for CodexAdapter {
    ...
    fn ingest_snapshot(&self, _raw: &str) -> Result<HarnessSnapshot, HarnessError> {
        Err(HarnessError::NotImplemented {
            harness: "codex",
            reason: "Codex adapter is trait-stub in V0.3.1; full implementation tracked in docs/versions/v0-3-1/prd.md §F47, deferred to V0.3.2+. Use --harness=claude or wait.",
        })
    }
    ...
    fn spawn_session(&self, _opts: SpawnOpts) -> Result<SessionHandle, HarnessError> {
        Err(HarnessError::NotImplemented {
            harness: "codex",
            reason: "Codex spawn is trait-stub in V0.3.1; full implementation tracked in docs/versions/v0-3-1/prd.md §F47 + docs/research/ccteam-codex-integration.md M1, deferred to V0.3.2+. Use --harness=claude or wait.",
        })
    }
...
docs/versions/v0-3-1/prd.md §F47 + docs/research/ccteam-codex-integration.md M1,
...
README pointer 更新;`docs/versions/v0-3-1/e2e-retro.md` 落档。
...
`docs/versions/v0-3-1/e2e-retro.md` —— 模仿 V0.3 / V0.2.2 retro 模板:
...
- `docs/versions/v0-2/README.md`:V0.3 起始 pointer 更新为"已 ship V0.3 + V0.3.1 起始"
...
- [ ] `docs/versions/v0-3-1/e2e-retro.md` 落档
- [ ] `docs/versions/v0-2/README.md` V0.3 pointer 更新
- [ ] `docs/dev-coupling-audit.md` F46-F51 close 标记
...
- README.md / `docs/versions/v0-3-1/README.md` § 关键设计决策 显式声明 codex 是
  V0.3.1 stub
...
| **PR #6** | **F51** chore + ship gate | `v0-3-1-ship-gate` | flex_e2e_test.rs / workspace.version bump 0.3.0 → 0.3.1 / CLAUDE.md baseline / docs/versions/v0-3-1/e2e-retro.md / docs sweep | PR #1-#5 全部 merge |
...
| 已 ship 里程碑 | ... + **V0.3.1**:F46-F51(6 finding 跨 6 PR:HarnessAdapter trait +
  ...
  ship gate)— 详 `docs/versions/v0-3-1/README.md` |
| 当前 next | V0.4 候选方向 — phase 编排演进恢复 + Codex 完整 + flex workflow
  promotion + Fat Skills 第一等;deferred 项见 `docs/versions/v0-3-1/prd.md §10` |
```
