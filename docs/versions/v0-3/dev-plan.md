...
>
> 配套文档:
> - 需求决策:`docs/versions/v0-3/prd.md`(12 节,~880 行)
> - 文档索引:`docs/versions/v0-3/README.md`
>
...
- [ ] **#5.4** retro 文档
  - `docs/versions/v0-3/e2e-retro.md`:模仿 V0.2.2 e2e-retro 模板,4-suite 跨 multi-session
    项目验证 dashboard / SSE / write action / 截图 / 鉴权
  - 跨浏览器 spot-check(Chrome / Firefox / Safari macOS)
- [ ] **#5.5** docs sweep
  - `docs/versions/v0-2/README.md`:V0.3 起始 pointer 改为 "已 ship V0.3:web UI"
...
- [ ] `docs/versions/v0-3/e2e-retro.md` 落档
...
- `docs/versions/v0-3/prd.md` §<N>(本 PR 对应 milestone 全文)
- `docs/versions/v0-3/dev-plan.md` §<N>(本 PR 任务 / 验收)
...
## Closes
- M5.0(`docs/versions/v0-3/prd.md` §3)
...
## Closes
- M5.1(`docs/versions/v0-3/prd.md` §4)
...
## Closes
- M5.2(`docs/versions/v0-3/prd.md` §5)
...
## Closes
- M5.3(`docs/versions/v0-3/prd.md` §6)
...
- `docs/versions/v0-3/e2e-retro.md`(新)
- `docs/versions/v0-2/README.md`(V0.3 pointer 改 ship)
- `docs/dev-coupling-audit.md`(F45 close)
...
## Closes
- V0.3 ship gate
- M5.4(`docs/versions/v0-3/prd.md` §7)
- `docs/dev-coupling-audit.md` F45 close
...
跨版本 SoT 不动:`docs/versions/v0-1/` `docs/versions/v0-2/` `docs/versions/v0-2-2/` 历史归档。
...
- 2026-05-10:初稿。基于 `docs/versions/v0-3/prd.md` + V0.2.2 dev-plan 风格参考拆 5 PR
