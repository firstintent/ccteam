...
- **状态**:待排 · **冲突域**:`crates/ccteam-web/web`(AccessView/SettingsPage/SettingsView/HostsView(JoinCard 壳)/lib/i18n/index.css/tests;**纯 SPA 零 Rust**) · **建议入口**:codex 委派(规划发卡 + review)
