...
>
> 配套文档:
> - 需求决策:`docs/versions/v0-2-2/prd.md`(13 节,1300 行)
> - 用户反馈源:`docs/versions/v0-2-2/feedback.md`
> - 文档索引:`docs/versions/v0-2-2/README.md`
>
...
- [ ] **#1.5** shell-out callsite + 文档 sweep
  ...
  - 全 forward-looking 文档 `ccteam <cmd>` → `cct <cmd>`;**`docs/versions/v0-1/` `docs/versions/v0-2/` 不动**(历史归档)
...
- [ ] forward-looking 文档全 `ccteam <cmd>` → `cct <cmd>`;`docs/versions/v0-1/` `docs/versions/v0-2/` 不动
...
- [ ] **#7.2** CLAUDE.md baseline 回填
  ...
  - "已 ship 里程碑"行加 V0.2.2 patch 段 — 详 docs/versions/v0-2-2/README.md
- [ ] **#7.3** docs/README.md patch 目录约定
  - 已 PR #1 落档(2026-05-09);本 PR 校验存在
- [ ] **#7.4** docs/versions/v0-2-2/e2e-retro.md
...
- [ ] `docs/versions/v0-2-2/e2e-retro.md` 落档
...
- `docs/versions/v0-2-2/e2e-retro.md`(新落)
...
1. `docs/versions/v0-2-2/prd.md` §8(F39 全文,~150 行)
2. `docs/versions/v0-2-2/dev-plan.md` §2(本 PR 步骤)
...
# 期望:0 命中(historical archive `docs/versions/v0-1/` `docs/versions/v0-2/` 不算)
...
## Closes
- F39(`docs/versions/v0-2-2/prd.md` §8)
...
1. `docs/versions/v0-2-2/prd.md` §3(F34 全文,~280 行)+ §6(F37 全文,~60 行)
2. `docs/versions/v0-2-2/dev-plan.md` §3(本 PR 步骤)
...
## Closes
- F34(`docs/versions/v0-2-2/prd.md` §3)
- F37(`docs/versions/v0-2-2/prd.md` §6)
...
1. `docs/versions/v0-2-2/prd.md` §4(F35 全文,~90 行)
2. `docs/versions/v0-2-2/dev-plan.md` §4(本 PR 步骤)
...
## Closes
- F35(`docs/versions/v0-2-2/prd.md` §4)
- `docs/dev-coupling-audit.md` F35 close
...
1. `docs/versions/v0-2-2/prd.md` §5(F36 全文,~50 行)
2. `docs/versions/v0-2-2/dev-plan.md` §5(本 PR 步骤)
...
## Closes
- F36(`docs/versions/v0-2-2/prd.md` §5)
- `docs/dev-coupling-audit.md` F36 close
...
1. `docs/versions/v0-2-2/prd.md` §7(F38 全文,~250 行,含 5 轮迭代敲定 vt100 + imageproc DIY)
2. `docs/versions/v0-2-2/dev-plan.md` §6(本 PR 步骤)
...
## Closes
- F38(`docs/versions/v0-2-2/prd.md` §7)
- `docs/dev-coupling-audit.md` F38 close
...
1. `docs/versions/v0-2-2/prd.md` §9(F40 全文,~110 行)
2. `docs/versions/v0-2-2/dev-plan.md` §7(本 PR 步骤)
...
## Closes
- F40(`docs/versions/v0-2-2/prd.md` §9)
- `docs/dev-coupling-audit.md` F40 close
...
1. `docs/versions/v0-2-2/prd.md` §12(version bump)+ §13(CLAUDE.md dev-flow)
2. `docs/versions/v0-2-2/dev-plan.md` §8(本 PR 步骤)+ §10(红线 grep 矩阵)+ §11(文档同步矩阵)
...
- `docs/versions/v0-2-2/e2e-retro.md` 落档(7 PR merge 后 dev / research smoke 联跑结果)
...
| **cct 命名约定** | `git grep -nE 'ccteam-(control\|team-author)' crates/ skills/ README.md CLAUDE.md` | 0 命中(historical archive `docs/versions/v0-1/` `docs/versions/v0-2/` 不算) | PR #1 / 全 PR ship gate |
...
| **#7 chore** | — | — | F34-F40 全 close 校验 | CLAUDE.md §一 baseline 回填;docs/versions/v0-2-2/e2e-retro.md 落档 |

跨版本 SoT 不动:`docs/versions/v0-1/` `docs/versions/v0-2/` 历史归档,反映当时 ship 实情(PR #1 sweep 显式排除)。
...
- [x] **#8.7** docs sweep 反向
  ...
  - `docs/versions/v0-2-2/{prd.md,dev-plan.md,README.md}`:加 F44 章节(本节);F39 §8 / PR #1 §2 全文不动作为历史
  - `docs/versions/v0-1/` / `docs/versions/v0-2/` 历史归档不动
  - `docs/versions/v0-2-2/e2e-retro.md` 不动(F39 ship 时的快照,反映当时实情)
...
- [x] `git grep -nE '\bcct\b' -- ':!docs/versions/v0-2-2/prd.md' ':!docs/versions/v0-2-2/dev-plan.md' ':!docs/versions/v0-2-2/README.md' ':!docs/versions/v0-2-2/e2e-retro.md' ':!docs/dev-coupling-audit.md' ':!docs/versions/v0-1' ':!docs/versions/v0-2/'` 在 forward-looking 源码 / 文档命中 0(F44 PRD / dev-plan / README + dev-coupling-audit F39 历史 + tool_surface.rs 反向迁移逻辑内 `cct-*` 检测字符串除外)
...
- `docs/versions/v0-2-2/{README,prd,dev-plan}.md` 三个加 F44
- `docs/dev-coupling-audit.md` F39 标 "已 F44 反向" + F44 新增条目
- `docs/versions/v0-2-2/e2e-retro.md` 不动(历史 e2e 快照)
...
- 2026-05-09:初稿。基于 `docs/versions/v0-2-2/prd.md` + V0.2 dev-plan 风格参考拆 7 PR
