...
export const I18N: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    tplBugT: "修复 Bug",
    tplBugD: "描述现象,交给 agent 定位修复",
    tplBugP: "帮我修一个 bug。\n现象:\n复现步骤:\n期望行为:",
    tplFeatT: "开发新功能",
    tplFeatD: "从需求到实现,再到自测",
    tplFeatP: "帮我实现一个新功能。\n需求:\n验收标准:",
    tplReviewT: "代码审查",
    tplReviewD: "审最近改动,找问题和简化点",
    tplReviewP: "审查当前未提交的改动和最近几个 commit,指出正确性问题、遗漏的边界情况和可以简化的地方。",
    tplTestT: "补充测试",
    tplTestD: "找出关键逻辑,补齐覆盖",
    tplTestP: "找出项目里最值得补测试的关键逻辑,先列清单给我确认,再逐个补齐。",
    tplDocsT: "更新文档",
    tplDocsD: "让 README 和文档跟上代码",
    tplDocsP: "对照当前代码,检查 README 和文档哪些已过时,把它们更新到与实际能力一致。",
    terminal: "终端",
    chatTab: "Chat",
    project: "项目",
    host: "主机",
  ...
  en: {
    ...
    tplBugT: "Fix a bug",
    tplBugD: "Describe the symptom; the agent hunts it down",
    tplBugP: "Help me fix a bug.\nSymptom:\nSteps to reproduce:\nExpected behavior:",
    tplFeatT: "Build a feature",
    tplFeatD: "From requirements to implementation and self-test",
    tplFeatP: "Help me build a new feature.\nRequirements:\nAcceptance criteria:",
    tplReviewT: "Review changes",
    tplReviewD: "Audit recent diffs for bugs and simplifications",
    tplReviewP: "Review the uncommitted changes and the last few commits: point out correctness issues, missed edge cases, and simplification opportunities.",
    tplTestT: "Add tests",
    tplTestD: "Find the critical gaps, then fill them",
    tplTestP: "Find the most test-worthy critical logic in this project, list it for my confirmation, then add the tests one by one.",
    tplDocsT: "Update docs",
    tplDocsD: "Bring README and docs up to date with the code",
    tplDocsP: "Check the README and docs against the current code, and update whatever is stale so they match actual capability.",
    terminal: "Terminal",
    chatTab: "Chat",
    project: "Project",
    host: "Host",
