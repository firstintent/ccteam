# v0.8.12 PRD — 市场改为「跟踪 upstream」(track-upstream marketplace)
...
> **关系**:**取代**已 ship 的 v0.8.9 市场「vendor 拷贝」模型(见 `docs/versions/v0-8-9/marketplace-design.md`,本版 supersede 之);与 v0.8.10(硬化)、v0.9.0(多机)**正交** —— 不能塞进 v0.8.10(那版铁律=只硬化不加功能)。版本号原占位 v0.8.11;2026-06-10 user(TG 1091)把 v0.8.11 定给「stream-json 适配 + 壳加厚主线」(见 `docs/versions/v0-8-11/prd.md`),本 PRD 顺移 v0.8.12 占位、相对排序仍灵活(user 定)。
