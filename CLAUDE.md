...
| 9 | `docs/versions/v0-6-3/README.md` | 看当前版本(V0.6.3 patch:F140 cron + F141 webhook + F142 vendor-seam + F143 squad routing)|
| 10 | `docs/versions/v0-6-1/README.md` | 上一版(V0.6.1 Epic D/E/F + F98 + F119-F139)|
| 11 | `docs/versions/v0-6-0/README.md` | 上一 minor(V0.6.0 Epic A/B/C + F106-F118 + 4-wave 范式)|

**起手 30 秒**:`git log -1` 看 HEAD → `cargo test --workspace 2>&1 | awk '/^test result/{p+=$4;f+=$6}END{print p,f}'` 校 1462/1 → 读用户诉求 → 干。
