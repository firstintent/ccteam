...
>
> 配套文档:
> - 需求决策:`docs/versions/v0-3-1/prd.md`(13 节)
> - 文档索引:`docs/versions/v0-3-1/README.md`
>
...
- [ ] **#2.5** 测试
  - `harness.rs::CodexAdapter::spawn_session` 返 `NotImplemented` + 错误
    消息含 "V0.3.1" / "deferred to V0.3.2" / "docs/versions/v0-3-1/prd.md §F47"
...
- [ ] `docs/versions/v0-3-1/e2e-retro.md` 落档(模仿 V0.3 / V0.2.2 retro 模板;
  4-suite 跨 flex 多 session / harness adapter / web UI / codex stub)
- [ ] `docs/versions/v0-2/README.md` V0.3 起始 pointer 更新为"已 ship V0.3 + V0.3.1"
...
- `docs/versions/v0-3-1/prd.md` §<N>(本 PR 对应 finding 全文)+ §1 战略背景 +
  §10 不在范围(避免 silently 拉前 V0.4 deferred)
- `docs/versions/v0-3-1/dev-plan.md` §<N>(本 PR 任务 / 验收)
...
## 关联
- 战略 pivot(`docs/versions/v0-3-1/prd.md §1`):V0.3 ship 后,V0.3.1 把 ccteam 从
...
| codex stub error 消息含追踪指针 | `git grep -nE 'docs/versions/v0-3-1/prd.md §F47\|deferred to V0.3.2' crates/ccteam-core/src/harness.rs` | ≥ 3 命中(spawn / ingest / shutdown 都指向) |
