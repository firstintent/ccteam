...
| 测试 baseline | `2039/0`(`cargo test --workspace --exclude ccteam-web`);`ccteam-web` = 292 pass;vitest 188 pass(SPA);Playwright 4 pass(SPA smoke)|
