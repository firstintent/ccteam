...
| 项 | 值 |
|---|---|
| Workspace version | `0.10.5`(**发布中**:owner 2026-08-29「ship」;合并 v0.10.4 周期(ccteam-ui 整页工作台 + LIFE-1)与 v0.10.5 波(插件自带引擎)一次发版,循 v0.10.3 先例取最高周期号。上一版 = v0.10.3(已发布 2026-08-19)) |
