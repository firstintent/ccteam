...
//! inside `ccteam-imd`. This test runs `cargo tree -p ccteam-core
...
fn ccteam_imd_owns_reqwest_dep() {
    ...
    assert!(
        ...
        "ccteam-imd should depend on reqwest:\n{stdout}"
    );
}
