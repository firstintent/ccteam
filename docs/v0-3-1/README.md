...
| **F51** Chore + ship gate | workspace.version 0.3.0 → 0.3.1、CLAUDE.md baseline 回填、e2e for flex multi-session、`docs/v0-3-1/e2e-retro.md`、README 更新 | P0 | 6 | shipped |
...
- `docs/v0-2/README.md` "已 ship V0.3" 段已更新为 "已 ship V0.3 + V0.3.1"
