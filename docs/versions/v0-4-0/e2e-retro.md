...
8. **`ccteam doctor --migrate-phase-to-workflow`** — `docs/versions/v0-4-0/migration-guide.md` 文档化了路径,
...
- [x] `docs/versions/v0-4-0/prd.md` — locked(F69 前已 ship)
- [x] `docs/versions/v0-4-0/dev-plan.md` — locked(F69 前已 ship)
- [x] `docs/versions/v0-4-0/README.md` — F69 ship 时更新状态行 + Findings 表
- [x] `docs/versions/v0-4-0/user-manual.md` — F69-docs ship
- [x] `docs/versions/v0-4-0/migration-guide.md` — F69-docs ship
- [x] `docs/versions/v0-4-0/e2e-retro.md` — 本文件(F69 ship 时填)
