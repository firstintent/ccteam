...
>
> 配套文档：
> - 需求决策：`docs/versions/v0-3-2/prd.md`（10 节，§3 locked decisions）
> - 文档索引：`docs/versions/v0-3-2/README.md`
>
...
- docs/versions/v0-3-2/prd.md §4 F52
...
- [ ] **#8.4** 文档
  - 新文件 `docs/versions/v0-3-2/user-manual.md`（参 V0.3.1 user-manual.md 结构）
  ...
  - 更新 `docs/versions/v0-3-2/README.md` 状态 → `shipped`
- [ ] **#8.5** ship gate
  - bump `Cargo.toml` `workspace.package.version` → `0.3.2`
  - `cargo test --workspace` 全绿；记录新 baseline
  - playwright suite 全绿
  - 写 `docs/versions/v0-3-2/e2e-retro.md`（参 V0.3.1 e2e-retro.md 结构）
...
## 任务来源
- `docs/versions/v0-3-2/prd.md` §4 F<N> 全文
- `docs/versions/v0-3-2/dev-plan.md` §<对应章节>
...
写完 `docs/versions/v0-3-2/e2e-retro.md` + bump `Cargo.toml` 后才发 ship gate PR。
